...
import com.faeddalberto.nbastats.scraper.domain.{Game, Player, Position}
import com.faeddalberto.nbastats.scraper.provider.StubGameStatsDocumentProvider
...
class StatsFactoryTest extends FlatSpec with Matchers {
  ...
  "StatsFactory.getGamesStats" should "return a map with games and stats for each player" in {
    ...
    val game :Game = Game("400578302", 2016, "Regular", new LocalDate(2015,10,29), "NY Knicks", 80, "Chicago Bulls", 104)
