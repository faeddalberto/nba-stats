package com.faeddalberto.nbastats.scraper.statsfinder

import com.faeddalberto.nbastats.scraper.domain.statistics._
import com.faeddalberto.nbastats.scraper.domain.{Position, Game, Player, PlayerMatchStats}
import com.faeddalberto.nbastats.scraper.playerfinder.PlayerFactory
import com.faeddalberto.nbastats.scraper.provider.{HtmlDocumentProvider, DocumentProvider}
import com.faeddalberto.nbastats.scraper.domain.statistics.Stats
import com.faeddalberto.nbastats.scraper.domain.{Position, Player, PlayerMatchStats, Game}
