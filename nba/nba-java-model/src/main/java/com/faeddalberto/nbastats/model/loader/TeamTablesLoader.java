...
public class TeamTablesLoader {
    ...
    public void insertTeamBatch(Team team, TeamsByConferenceDivision teamsByConferenceDivision, List<TeamRosterByYearPlayer> teamRosterByYearPlayerList) throws Exception {
    ...
    private List<Insert> teamRosterByYearInsert(List<TeamRosterByYearPlayer> teamRosterByYearPlayerList) {
        ...
        for (TeamRosterByYearPlayer teamPlayer : teamRosterByYearPlayerList) {
