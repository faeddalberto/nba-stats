...
public interface PlayerStatsByGameAccessor {
    ...
    @Query("INSERT INTO nba.player_stats_by_game (game_id, player_id, date, season, player_team, player_role, opponent_team, mins_played, player_name, fg_ma, tp_ma, ft_ma, off_reb, def_reb, tot_reb, ast, stl, bks, tov, pf, pm, pts) VALUES (:game_id, :player_id, :date, :season, :player_team, :player_role, :opponent_team, :mins_played, :player_name, :fg_ma, :tp_ma, :ft_ma, :off_reb, :def_reb, :tot_reb, :ast, :stl, :bks, :tov, :pf, :pm, :pts)")
    Statement insertPlayerStatsByGame(@Param("game_id") UUID gameId, @Param("player_id") UUID playerId, @Param("date") Date date, @Param("season") int season, @Param("player_team") String playerTeam, @Param("player_role") String playerRole, @Param("opponent_team") String opponentTeam, @Param("mins_played") int minsPlayed, @Param("player_name") String playerName, @Param("fg_ma") MadeAttemptedStat fieldGoals, @Param("tp_ma") MadeAttemptedStat threePoints, @Param("ft_ma") MadeAttemptedStat freeThrows, @Param("off_reb") int offReb, @Param("def_reb") int defReb, @Param("tot_reb") int totalReb, @Param("ast") int assists, @Param("stl") int steals, @Param("bks") int blocks, @Param("tov") int turnovers, @Param("pf") int personalFauls, @Param("pm") int plusMinus, @Param("pts") int points);
}
